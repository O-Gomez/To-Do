...
<body>
    <div class="contenedor">
        <div class="centrado">
            ...
            <button type="button" class="btnn btn-todo" title="Eliminar todos" onclick="vaciar();">Vaciar Lista</button>
            <!-- Boton para eliminar seleccionados -->
            <button type="button" class="btnn btn-selec" title="Eliminar selección" onclick="seleccionados();">-</button>
            <!-- Inicio lista de tareas -->
            <div class="list-group">
                <!-- Inicio lista dinamica -->
                <div class="left-custom-menu-adp-wrap comment-scrollbar" style="max-height: 368px;">
                    ...
                    <div id="lista">
                        ...
                        ?>
                            ...
                            <div class="li" id="a<?php echo $tarea; ?>">
                                <label class="list-group-item d-flex gap-3">
                                    ...
                                    <span class="pt-1 form-checked-content mucho-texto" title="<?php echo $tupla['contenido']; ?>">
                            ...
                            <div class="ocultar" id="b<?php echo $tarea; ?>">
                                <label class="list-group-item d-flex gap-3">
                                    <form id="act_form">
                ...
                <label class="list-group-item d-flex gap-3 bg-light">
                    <form id="agregar_form">
                        <span class="pt-1 form-checked-content" id="aaaa">
                            <input class="nueva" type="text" placeholder="Nueva tarea..." maxlength="90" name="agg_tarea" id="agg_tarea" required>
                        </span>
                    </form>
                </label>
